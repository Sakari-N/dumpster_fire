...
static int elu_native_command_line_to_arguments(const WCHAR* native_command, size_t* argument_count_address, size_t** argument_length_table_address, char*** argument_table_address)
{
	...
	__assume(
		page_size == (size_t)0x1 || page_size == (size_t)0x2 || page_size == (size_t)0x4 || page_size == (size_t)0x8 ||
		page_size == (size_t)0x10 || page_size == (size_t)0x20 || page_size == (size_t)0x40 || page_size == (size_t)0x80 ||
		page_size == (size_t)0x100 || page_size == (size_t)0x200 || page_size == (size_t)0x400 || page_size == (size_t)0x800 ||
		page_size == (size_t)0x1000 || page_size == (size_t)0x2000 || page_size == (size_t)0x4000 || page_size == (size_t)0x8000 ||
		page_size == (size_t)0x10000 || page_size == (size_t)0x20000 || page_size == (size_t)0x40000 || page_size == (size_t)0x80000 ||
		page_size == (size_t)0x100000 || page_size == (size_t)0x200000 || page_size == (size_t)0x400000 || page_size == (size_t)0x800000 ||
		page_size == (size_t)0x1000000 || page_size == (size_t)0x2000000 || page_size == (size_t)0x4000000 || page_size == (size_t)0x8000000 ||
		page_size == (size_t)0x10000000 || page_size == (size_t)0x20000000 || page_size == (size_t)0x40000000 || page_size == (size_t)0x80000000);
#endif
...
int elu_get_process_arguments(size_t* argument_count_address, size_t** argument_length_table_address, char*** argument_table_address)
{
	...
	return elu_native_command_line_to_arguments(native_command_line, argument_count_address, argument_length_table_address, argument_table_address);
}
